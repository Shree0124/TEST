...
//       }}>
//         {images.map((img, i) => {
//         const baseUrl = img.imageUrl ? img.imageUrl.split('?')[0] : null;
//           console.log('FIlter  [Carousel] slide', i, img.display_name, '→', img.imageUrl);
//           return (
//             <div key={img.id || i} style={{ minWidth: '100%', position: 'relative', height: 420 }}>
//               {img.baseUrl ? (
//                 <img
//                   src={img.baseUrl}
...
//                   onError={e => {
//                     console.error('[Carousel] img failed:', img.baseUrl);
//                     e.target.style.display = 'none';
//                     if (e.target.nextSibling) e.target.nextSibling.style.display = 'flex';
//                   }}
//                   onLoad={() => console.log('[Carousel] img loaded:', img.baseUrl)}
//                 />
//               ) : null}

//               {/* Fallback */}
//               <div style={{
//                 display: img.imageUrl ? 'none' : 'flex',
...
//   // Debug: log featured images when they load
//   useEffect(() => {
...
//       }}>
//         {images.map((img, i) => {
//           const baseUrl = img.imageUrl || null; // ✅ FIXED: was img.baseUrl (undefined)

//           return (
//             <div key={img.id || i} style={{ minWidth: '100%', position: 'relative', height: 420 }}>
//               {baseUrl ? ( // ✅ FIXED: was img.baseUrl
//                 <img
//                   src={baseUrl} // ✅ FIXED: was img.baseUrl
//                   alt={img.display_name}
//                   loading={i === 0 ? 'eager' : 'lazy'}
//                   style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }}
//                   onError={e => {
...
//               {/* Fallback */}
//               <div style={{
//                 display: baseUrl ? 'none' : 'flex', // ✅ FIXED: was img.imageUrl
//                 position: 'absolute', inset: 0,
//                 alignItems: 'center', justifyContent: 'center',
//                 fontSize: '4rem', background: 'var(--bg3)',
//               }}>🦋</div>
